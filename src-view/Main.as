package  
{
	import com.dayvson.subtitle.SubtitleManager;
	...
	public class Main extends Sprite
	{
		...
		{	
			var man:SubtitleManager = new SubtitleManager();
			man.addItem("fixtures/bigbang.srt", SubtitleManager.SRT_KIND, "big", "PT-BR");
